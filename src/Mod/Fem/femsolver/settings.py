...
To make the solver recognize settings for a new solver have a
look at :class:`_SolverDlg`.
"""
...
_SOLVER_PARAM = {
    "Suqaba": _SolverDlg(
        default="suqaba",
        param_path=_PARAM_PATH + "Suqaba",
        use_default="UseStandardSuqabaLocation",
        custom_path="suqabaBinaryPath",
    ),
}
