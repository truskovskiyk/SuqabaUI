...
class FemInputWriter:
    def __init__(
        ...
        if self.mesh_object:
            ...
            pass
            # FreeCAD.Console.PrintWarning(
            #     "Warning (FemInputWriter): No finite element mesh object was "
            #     "given to the writer class. In rare cases this might not be "
            #     "an error (e.g. Suqaba solver will automatically compute the "
            #     "mesh for you).\n"
            # )
